...
const WAFFLE_SW_VERSION = 'v11.4.33-care-card-readability-2026.09.23.07';
...
const APP_SHELL = [
  ...
  './waffle-build.json',
  './waffle-release.json',
'./waffle-bootstrap.js?v=2026.08.28.01&rev=2026.09.23.05',
...
'./waffle-runtime.css?v=2026.08.28.01&rev=2026.09.23.05',
