...
const WAFFLE_SW_VERSION = 'v11.4.16-palz-stay-clean-header-2026.09.15.05';
...
const APP_SHELL = [
  ...
  './waffle-build.json',
  './waffle-release.json',
'./waffle-bootstrap.js?v=2026.08.28.01&rev=2026.09.15.05',
...
'./waffle-runtime.css?v=2026.08.28.01&rev=2026.09.15.05',
