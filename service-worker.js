...
const WAFFLE_SW_VERSION = 'v11.4.6-upcoming-arrivals-2026.09.09.02';
...
const APP_SHELL = [
  ...
  './waffle-build.json',
  './waffle-release.json',
  './waffle-bootstrap.js?v=2026.08.28.01&rev=2026.09.09.02',
  ...
  './waffle-runtime.css?v=2026.08.28.01&rev=2026.09.10.01',
