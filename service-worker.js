...
const WAFFLE_SW_VERSION = 'v11.4.15-palz-stay-no-brackets-2026.09.15.04';
...
const APP_SHELL = [
  ...
  './waffle-build.json',
  './waffle-release.json',
'./waffle-bootstrap.js?v=2026.08.28.01&rev=2026.09.15.04',
...
'./waffle-runtime.css?v=2026.08.28.01&rev=2026.09.15.04',
