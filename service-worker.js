...
const WAFFLE_SW_VERSION = 'v11.4.18-care-mobile-clean-header-2026.09.16.01';
...
const APP_SHELL = [
  ...
  './waffle-build.json',
  './waffle-release.json',
'./waffle-bootstrap.js?v=2026.08.28.01&rev=2026.09.16.01',
...
'./waffle-runtime.css?v=2026.08.28.01&rev=2026.09.16.01',
