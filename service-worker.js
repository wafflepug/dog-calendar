...
const WAFFLE_SW_VERSION = 'v11.4.39-load-later-care-arrivals-on-demand-2026.09.23.14';
...
const APP_SHELL = [
  ...
  './waffle-build.json',
  './waffle-release.json',
'./waffle-bootstrap.js?v=2026.08.28.01&rev=2026.09.23.14',
...
'./waffle-runtime.css?v=2026.08.28.01&rev=2026.09.23.14',
