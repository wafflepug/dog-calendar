...
const WAFFLE_SW_VERSION = 'v11.4.17-mobile-brand-consistency-2026.09.15.06';
...
const APP_SHELL = [
  ...
  './waffle-build.json',
  './waffle-release.json',
'./waffle-bootstrap.js?v=2026.08.28.01&rev=2026.09.15.06',
...
'./waffle-runtime.css?v=2026.08.28.01&rev=2026.09.15.06',
