...
for path in ('index.html', 'directory.html', 'reminders.html', 'audit.html'):
    require(path, 'rev=2026.09.24.16')
require('waffle-bootstrap.js', "ASSET_REVISION = '2026.09.24.16'")
require('service-worker.js', 'v11.4.41-care-readiness-checklist-2026.09.24.16')
require('waffle-build.json', 'Add the Care readiness checklist')
require('waffle-release.json', 'Add the Care readiness checklist')
