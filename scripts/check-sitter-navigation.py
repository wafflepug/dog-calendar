...
required = {
    ...
    'potential helper content removed': 'section[aria-labelledby="whHomePotentialsTitle"] #whHomeAddPotentialBtn',
    'outlook popover suppression': 'suppressOutlookPopover',
    'flat mobile brand header': '.v10-ops-heading{background:transparent!important;box-shadow:none!important}',
    'Palz accent binding': 'background:var(--wh75-accent,#7c3aed)',
    'mobile bracket removal': '.v10-ops-heading::before',
    'menu-side accent removal': '.v10-ops-heading{background:transparent!important;box-shadow:none!important}',
